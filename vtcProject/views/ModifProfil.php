...
?>
    ...
    <form  class= "form" action="../controllers/ModifProfilController.php" method="POST" style=" max-width:50%;margin-top: 5%;" enctype="multipart/form-data">
        ...
        <div class= "inputName">
        <label style="font-size: 20px;" >Voulez vous changer votre statut en transporteur ?</label>
        ...
        <div class= "inputName">
        <label for="avatar">Modifier la photos de profile:</label>

        <input type="file" id="avatar" name="image" accept="image/png, image/jpeg">
        </div>
        <button class="submit formEntry" name="submit">Valider</button>
