...
public function GestionAnnonces (array $rows ){
...
<div class="container-fluid">
    <div class="row flex-nowrap">
        ...
        <h1 style="display:felx;height:10px;">Gestion des annonces</h1>
        <div style="margin-top:12%;margin-left:-19%;width:100%;">
        <?php
                $dataTable->afficherAnnonces($rows);
               ?>
               </div>
    </div>
</div>
