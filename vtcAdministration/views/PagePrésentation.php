...
<div class="container-fluid">
    <div class="row flex-nowrap">
        ...
        <h1 style="display:felx;height:20px; width:16%">Modifier présentation de la VTC</h1>
            
             
              
            <form id="form" enctype="multipart/form-data" action="../controllers/PresentationController.php" method="POST">
              
             <input type="text"  class="fadeIn second" name="titre" placeholder="Titre Présentation"/>
             <textarea id="pass" class="fadeIn third" name="des" placeholder="Description VtcAlgerienne"></textarea>
             <div style="margin-top:3%;margin-bottom: 1%; margin-left:2%; ">
             <input type="hidden" name="MAX_FILE_SIZE" value="30000" />
             <label  >Image:</label>
             <input name="image" type="file" accept="image/png" />
            </div>
            <div style="margin-top:-3%;   margin-bottom: 2%;margin-left:40%;">
             <label  >Video:</label>
             <input name="video" type="file"  />
            </div>
           
            
              <input type="submit" name="sendP" value="Modifier"  class="fadeIn fourth"/>
              </form>
