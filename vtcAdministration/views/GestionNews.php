...
public function GestionAllNews (array $rows ){
...
<div class="container-fluid">
    <div class="row flex-nowrap">
        ...
        <h1 style="display:felx;height:10px;">Gestion des news</h1>
        <div style="margin-top:12%;margin-left:-15%;width:100%;">
        <?php
             $dataTable->afficherNews($rows);
               ?>
               </div>
    </div>
</div>
